...
export const CASE_STATUSES = {
  ...
  SALES_APPROVAL: 'Sales Approved' as CaseStatus,
  ...
  PENDING_DELIVERY_OFFICE: 'Pending Collection (At Hospital)' as CaseStatus,
...
export const STATUS_LABELS = {
  ...
  [CASE_STATUSES.SALES_APPROVAL]: 'Sales Approved',
  ...
  [CASE_STATUSES.PENDING_DELIVERY_OFFICE]: 'Pending Collection',
...
export const STATUS_DESCRIPTIONS = {
  ...
  [CASE_STATUSES.PENDING_DELIVERY_OFFICE]: 'Equipment is pending collection at hospital',
